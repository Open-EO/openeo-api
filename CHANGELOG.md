...
- `GET /jobs/{job_id}/logs`, `GET /services/{service_id}/logs` and `POST /result`: Added `log_levels` property in responses to indicate the log levels that are included. [#329](https://github.com/Open-EO/openeo-api/issues/329)
