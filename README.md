...
The openEO (core) API is currently released in version **0.3.0**. This branch specifies the pre-release version **0.4-draft**.
...
| [0.3.0](https://github.com/Open-EO/openeo-api/tree/0.3.0) ([Spec](https://open-eo.github.io/openeo-api/v/0.3.0/index.html)) | current | Major rework. |
